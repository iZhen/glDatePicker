...
(function(exports, $) {
    ...
    var datePicker = (function() {
        ...
        dp.prototype = {
            show: function() {
                var self = this;
                if(!self.calendar.renderTo.hasClass(NAME_SPACE)) {
                    // not has NAME_SPACE and 'calendar' class name at same time
                    // it's should be use common calendar object.
                    var $wrap = $('.' + NAME_SPACE + '-dropdown');
    ...
    var addDropdownCalendar = function(type) {
        ...
        var $wrap = $('.' + NAME_SPACE + '.' + NAME_SPACE + '-dropdown');
        // if wrap object not exist, build it.
        if(!$wrap.length) {
            // define object
            $wrap = $('<div class="' + NAME_SPACE + ' ' + NAME_SPACE + '-dropdown"/>');
            $wrap.appendTo('body');
            // bind hide event
        ...
        $calendar = $('.' + NAME_SPACE + '-' + type, $wrap);
        // if not exist calendar-type object, create it.
        if(!$calendar.length) {
            calendar = new Calendar(type);
            calendar.renderTo = $('<div class="calendar ' + NAME_SPACE + '-' + type + '"/>');
    ...
    var addDropdownRangeCalendar = function(type) {
        // get exist wrap object.
        var $wrap = $('.' + NAME_SPACE + '.' + NAME_SPACE + '-range.' + NAME_SPACE + '-dropdown');
        // if wrap object not exist, build it.
        if(!$wrap.length) {
            // define object
            $wrap = $('<div class="' + NAME_SPACE + ' ' + NAME_SPACE + '-range.' + ' ' + NAME_SPACE + '-dropdown"/>');
            $wrap.appendTo('body');
            // bind hide event
            $(document).on('mouseup', (function($wrap){
                return function(e) {
